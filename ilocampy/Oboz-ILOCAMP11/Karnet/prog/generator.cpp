...
int main() {
    ...
    gen.beginGroup(); //2
    {
        ...
        gen.addTest(randomSequence(20, 10, 1, 20));
        Generator::setSeed(68161);
        gen.addTest(sortedSequence(20, 10, 1, 20, false));
    ...
    gen.beginGroup(); //3
    {
        ...
        gen.addTest(randomSequence(200, 50, 1, 1000));
        Generator::setSeed(985832);
        gen.addTest(randomSequence(200, 50, 1, 10));
        Generator::setSeed(97644);
        gen.addTest(randomSequence(200, 50, 100, 110));
        Generator::setSeed(57580);
        gen.addTest(randomSequence(200, 50, 1, 100));
    }
    gen.endGroup();
    ...
    gen.beginGroup(); //4
    {
        ...
        gen.addTest(randomSequence(1000, 100, 1, 20));
    ...
    gen.beginGroup(); //5
    {
        ...
        gen.addTest(randomSequence(50000, 100, 1, 1000000000));
    ...
    gen.beginGroup(); //6
    {
        ...
        gen.addTest(randomSequence(n, q, 1, 1000000000));
        Generator::setSeed(41312);
        gen.addTest(randomSequence(n, q, 1, 10));
