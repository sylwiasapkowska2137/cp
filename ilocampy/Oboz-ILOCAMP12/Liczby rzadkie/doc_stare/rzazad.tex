% walczylem, walczylem, walczylem
% i przegralem, nie udalo mi sie zmusic latexa do skompilowania z polskimi znakami, wiec jest jak jest

\documentclass[zad,zawodnik]{sinol}
  \title{Liczby rzadkie}
  \id{rza}
  \signature{jtom???}
  \author{Micha\l{} Majewski} % Autor zadania
  \pagestyle{fancy}
  \iomode{stdin}
  % HINT: Pola konkurs, etap, day, date uzupelnia kierownik konkursu.
  \etap{pocz\k{a}tkuj\k{a}ca}
  \day{???}
  \date{??.09.2013}
